                      ...
                      <Link className='footer-link' to='/'>
                       ...
                       <li className='footer-item footerItem'>
                          ...
                          <select className='footer-select' name="" id="">
                              <option value="uz" className="footer-options">uz</option>
                              <option value="ru" className="footer-options">ru</option>
                              <option value="eng" className="footer-options">eng</option>
                          </select>

                       </li>
                       <li className='footer-item' id='footer-item'>
                         <a className='footer-item-link' target='_blank' href='https://context.reverso.net/%D0%BF%D0%B5%D1%80%D0%B5%D0%B2%D0%BE%D0%B4/%D0%B0%D0%BD%D0%B3%D0%BB%D0%B8%D0%B9%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B8%D0%B9/Wek'>
                           <img className='images-foter' src={wek} alt="logo images" />
                        </a>
                        <a className='footer-item-link' target='_blank' href='https://www.instagram.com/doniyrovalimardon'>
                           <img src={instag} alt="logo images" />
                        </a>
                        <a className='footer-item-link' target='_blank' href='https://t.me/portfolioproject'>
                           <img src={teleg} alt="logo images" />
                        </a>
                        <a className='footer-item-link' target='_blank' href='https://www.watsapp.com/Alimardon'>
