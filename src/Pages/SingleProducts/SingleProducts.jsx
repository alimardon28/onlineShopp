        ...
        <div className="container">
          <div className="single-products">
            ...
            <div className="imagesBox">
              <img
                src={dataProducts.thumbnailUrl}
                alt={`${dataProducts.title} images`}
              />
              <img
          ...
          <div className="sinleProductsBox">
            <div className="sinleProductsBox-left">
              <div className="opitsaneBox">
                <h3 className="opisaneBox-heading">
            ...
            <div className="buttonBox">
              <Link className="singliBtnLink" to="/corzinka">
                <button
                  className="button"
                  id={dataProducts.id}
                  onClick={(e) => handleKupitCorzinka(e.target.id)}
                >
                  купить !
                </button>
              </Link>
              <button
                id={dataProducts.id}
                onClick={(e) => handleCorzinkaAdd(e.target.id)}
                className="button"
              >
