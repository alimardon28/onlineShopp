        ...
        <form action="" className="form">
          <div className="orderingLeft">
            <div className="orderingSums">
              ...
              <span className="orderingSpan">0</span>
            </div>
          ...
          <div className="orderingRight">
            <div className="orderingRightZakaz">
              ...
              <div className="orderingProducts">
                <span className="orderingProducts-didmount">0</span>
                <h4 className="orderingProducts-title">
                  Наушники Apple BYZ S852I
                </h4>
                <span className="orderingProducts-sum">$ 2 927</span>
              </div>

              <div className="orderingDelivery">
                <h4 className="orderingDelivery-title">Доставка</h4>
                <span className="orderingDelivery-sum">$ 2 927</span>
              </div>

              <div className="orderingPay">
                <h4 className="orderingPay-title">К оплате</h4>
                <span className="orderingPay-sum">$ 2 927</span>
              </div>
            </div>
            ...
            <div className="orderingNumbers">
              ...
              <input type="text" required placeholder="+ 777  __ __ __ __" />
            </div>

            <div className="orderingBoxBtn">
              <Link to="/order" className="orderingBtn">
